...
public class MainViewer {
	...
	public static void mainMenuView(){
		System.out.println("항공권 예약 프로그램");
	...
	public static void airlineMenuView() {
		...
		System.out.println("1. 항공사 조회하기 2. 항공사 등록하기 3. 항공사 수정하기 4. 항공사 삭제하기 5. 메인 메뉴로 돌아가기");
	}

	public static void flightMenuView() {
		System.out.println("=============항공편 관리=============");
		System.out.println("1. 항공편 조회하기 2. 항공편 등록하기 3. 항공편 수정하기 4. 항공편 삭제하기 5. 메인 메뉴로 돌아가기");
	}

	public static void reservationMenuView() {
		System.out.println("=============항공권 예약 관리=============");
		System.out.println("1. 항공권 조회하기 2. 항공권 예약하기 3. 항공권 수정하기 4. 항공권 삭제하기 5. 메인 메뉴로 돌아가기");
	}
